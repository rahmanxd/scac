// api/og-image.js - Generate OG Image for Farcaster
  ...
  const svg = `
    <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="600" y="450" font-size="32" text-anchor="middle" fill="white" opacity="0.9" font-family="Arial, sans-serif">
        Analisis popularitas cast di Farcaster
      </text>
      
      <!-- Bottom text -->
      <text x="600" y="550" font-size="24" text-anchor="middle" fill="white" opacity="0.7" font-family="Arial, sans-serif">
